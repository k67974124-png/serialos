...
28. `docs/adr/0001-foundation-toolchain-and-boundaries.md`：ADR-0001: Foundation toolchain and package boundaries
29. `docs/adr/0002-sql-migrations-and-typed-data-access.md`：ADR-0002: SQL migrations and typed data access
30. `docs/adr/0003-postgresql-jobs-and-outbox.md`：ADR-0003: PostgreSQL durable jobs and transactional outbox
31. `docs/adr/0004-contract-canonical-sources.md`：ADR-0004: Canonical contract sources and generated TypeScript types
32. `docs/adr/README.md`：Architecture Decision Records
33. `docs/glossary.md`：术语表
34. `docs/plans/E00-foundation.md`：E00 工程基座执行计划
35. `tasks/E00-foundation.md`：E00 工程基座
36. `tasks/E01-auth-onboarding.md`：E01 认证、工作区与首次引导
37. `tasks/E02-material-inbox.md`：E02 素材收件箱
38. `tasks/E03-ai-ingestion-assets.md`：E03 AI 入库与观点资产
39. `tasks/E04-profile-columns.md`：E04 创作者画像与栏目完善
40. `tasks/E05-topic-meeting.md`：E05 AI 选题会
41. `tasks/E06-content-run-interview.md`：E06 制作任务与补充采访
42. `tasks/E07-content-pack-editor.md`：E07 内容包生成与编辑器
43. `tasks/E08-claims-review-approval.md`：E08 声明账本、质量门与批准
44. `tasks/E09-interactive-artifacts.md`：E09 安全互动作品
45. `tasks/E10-export-feedback.md`：E10 导出、发布记录与反馈回流
46. `tasks/E11-release-hardening.md`：E11 设计伙伴发布硬化
47. `tasks/README.md`：实施任务索引
48. `prompts/00-bootstrap.md`：E00 工程基座
49. `prompts/00-e00-plan-acceptance.md`：SerialOS 第一轮规划验收指令
50. `prompts/01-auth-onboarding.md`：E01 认证、工作区与首次引导
51. `prompts/02-materials.md`：E02 素材收件箱
52. `prompts/03-assets.md`：E03 AI 入库与观点资产
53. `prompts/04-profile-columns.md`：E04 创作者画像与栏目
54. `prompts/05-topics.md`：E05 AI 选题会
55. `prompts/06-content-run.md`：E06 制作任务与补充采访
56. `prompts/07-content-pack.md`：E07 内容包生成与编辑器
57. `prompts/08-review.md`：E08 声明账本、审校与批准
58. `prompts/09-artifacts.md`：E09 安全互动作品
59. `prompts/10-export.md`：E10 导出、发布记录与反馈
60. `prompts/11-release-hardening.md`：E11 设计伙伴发布硬化
61. `prompts/README.md`：Codex 启动指令
62. `.agents/skills/implement-vertical-slice/SKILL.md`：Implement an approved SerialOS vertical slice
63. `.agents/skills/plan-vertical-slice/SKILL.md`：Plan a SerialOS vertical slice
64. `.agents/skills/review-product-requirements/SKILL.md`：Review SerialOS requirements before implementation
65. `.agents/skills/verify-release/SKILL.md`：Verify a SerialOS slice or release
66. `contracts/error-codes.md`：Error Codes
67. `contracts/events.md`：Domain Events
68. `contracts/openapi.yaml`：Machine-readable contract or support file
69. `db/schema.sql`：Machine-readable contract or support file
70. `db/seed.md`：Seed 数据规范
71. `schemas/content-brief.schema.json`：Machine-readable contract or support file
72. `schemas/content-pack.schema.json`：Machine-readable contract or support file
73. `schemas/creator-profile.schema.json`：Machine-readable contract or support file
74. `schemas/insight-asset.schema.json`：Machine-readable contract or support file
75. `schemas/interactive-artifact.schema.json`：Machine-readable contract or support file
76. `schemas/material-item.schema.json`：Machine-readable contract or support file
77. `schemas/review-result.schema.json`：Machine-readable contract or support file
78. `schemas/source-claim.schema.json`：Machine-readable contract or support file
79. `schemas/topic-candidate.schema.json`：Machine-readable contract or support file
80. `examples/content-brief.example.json`：Machine-readable contract or support file
81. `examples/content-pack.example.json`：Machine-readable contract or support file
82. `examples/creator-profile.example.json`：Machine-readable contract or support file
83. `examples/insight-asset.example.json`：Machine-readable contract or support file
84. `examples/interactive-artifact.example.json`：Machine-readable contract or support file
85. `examples/material-item.example.json`：Machine-readable contract or support file
86. `examples/README.md`：Contract Examples
87. `examples/review-result.example.json`：Machine-readable contract or support file
88. `examples/source-claim.example.json`：Machine-readable contract or support file
89. `examples/topic-candidate.example.json`：Machine-readable contract or support file
90. `evals/README.md`：AI Eval Assets
91. `scripts/build_handoff.py`：!/usr/bin/env python3
92. `scripts/requirements.txt`：Machine-readable contract or support file
93. `scripts/validate_specs.py`：!/usr/bin/env python3
...
<a id="source-28"></a>
# Source 28: `docs/adr/0001-foundation-toolchain-and-boundaries.md`

SHA-256: `839deb45dd769ce3408a5f0c2828589b68174fdc1df24bf6e32183e71e3773dd`
Bytes: `2940`
...
<a id="source-29"></a>
# Source 29: `docs/adr/0002-sql-migrations-and-typed-data-access.md`

SHA-256: `e3a9c7903819515415bac76666e884c0434fedee62e0f2f88c8ff7cbe0b2811c`
Bytes: `3362`
...
<a id="source-30"></a>
# Source 30: `docs/adr/0003-postgresql-jobs-and-outbox.md`

SHA-256: `07aab02fa1278a3819d9a5e7e745d80c89a1cd8d4299ec5862c979be5f02b1b3`
Bytes: `3173`
...
<a id="source-31"></a>
# Source 31: `docs/adr/0004-contract-canonical-sources.md`

SHA-256: `d1f4270a7e3237add5192f7d97b2e0a7a1029fc927fbde3c246aac18dfe3e421`
Bytes: `2730`
...
<a id="source-34"></a>
# Source 34: `docs/plans/E00-foundation.md`

SHA-256: `cc007a0de9225e00aac467eba2221e4728dde20ff76cb7af581d4b19d3c88c4f`
Bytes: `40255`
...
<a id="source-35"></a>
# Source 35: `tasks/E00-foundation.md`

SHA-256: `03390208a4d1d9d991519ac4694c042c5a700aa4f931909bb4119a8d3b17482d`
Bytes: `7468`
...
<a id="source-36"></a>
# Source 36: `tasks/E01-auth-onboarding.md`
...
<a id="source-37"></a>
# Source 37: `tasks/E02-material-inbox.md`
...
<a id="source-38"></a>
# Source 38: `tasks/E03-ai-ingestion-assets.md`
...
<a id="source-39"></a>
# Source 39: `tasks/E04-profile-columns.md`
...
<a id="source-40"></a>
# Source 40: `tasks/E05-topic-meeting.md`
...
<a id="source-41"></a>
# Source 41: `tasks/E06-content-run-interview.md`
...
<a id="source-42"></a>
# Source 42: `tasks/E07-content-pack-editor.md`
...
<a id="source-43"></a>
# Source 43: `tasks/E08-claims-review-approval.md`
...
<a id="source-44"></a>
# Source 44: `tasks/E09-interactive-artifacts.md`
...
<a id="source-45"></a>
# Source 45: `tasks/E10-export-feedback.md`
...
<a id="source-46"></a>
# Source 46: `tasks/E11-release-hardening.md`
...
<a id="source-48"></a>
# Source 48: `prompts/00-bootstrap.md`
...
<a id="source-49"></a>
# Source 49: `prompts/00-e00-plan-acceptance.md`

SHA-256: `a226b65e021c87aab5e31f425aeb8c8beaacf0f7d81c709c9ce474027bd7dec9`
Bytes: `22426`
...
<a id="source-50"></a>
# Source 50: `prompts/01-auth-onboarding.md`
...
<a id="source-51"></a>
# Source 51: `prompts/02-materials.md`
...
<a id="source-52"></a>
# Source 52: `prompts/03-assets.md`
...
<a id="source-53"></a>
# Source 53: `prompts/04-profile-columns.md`
...
<a id="source-54"></a>
# Source 54: `prompts/05-topics.md`
...
<a id="source-55"></a>
# Source 55: `prompts/06-content-run.md`
...
<a id="source-56"></a>
# Source 56: `prompts/07-content-pack.md`
...
<a id="source-57"></a>
# Source 57: `prompts/08-review.md`
...
<a id="source-58"></a>
# Source 58: `prompts/09-artifacts.md`
...
<a id="source-59"></a>
# Source 59: `prompts/10-export.md`
...
<a id="source-60"></a>
# Source 60: `prompts/11-release-hardening.md`
...
<a id="source-62"></a>
# Source 62: `.agents/skills/implement-vertical-slice/SKILL.md`
...
<a id="source-63"></a>
# Source 63: `.agents/skills/plan-vertical-slice/SKILL.md`
...
<a id="source-64"></a>
# Source 64: `.agents/skills/review-product-requirements/SKILL.md`
...
<a id="source-65"></a>
# Source 65: `.agents/skills/verify-release/SKILL.md`
...
<a id="source-66"></a>
# Source 66: `contracts/error-codes.md`
...
<a id="source-68"></a>
# Source 68: `contracts/openapi.yaml`
...
<a id="source-71"></a>
# Source 71: `schemas/content-brief.schema.json`
...
<a id="source-72"></a>
# Source 72: `schemas/content-pack.schema.json`
...
<a id="source-73"></a>
# Source 73: `schemas/creator-profile.schema.json`
...
<a id="source-74"></a>
# Source 74: `schemas/insight-asset.schema.json`
...
<a id="source-75"></a>
# Source 75: `schemas/interactive-artifact.schema.json`
...
<a id="source-76"></a>
# Source 76: `schemas/material-item.schema.json`
...
<a id="source-77"></a>
# Source 77: `schemas/review-result.schema.json`
...
<a id="source-78"></a>
# Source 78: `schemas/source-claim.schema.json`
...
<a id="source-79"></a>
# Source 79: `schemas/topic-candidate.schema.json`
...
<a id="source-80"></a>
# Source 80: `examples/content-brief.example.json`
...
<a id="source-81"></a>
# Source 81: `examples/content-pack.example.json`
...
<a id="source-82"></a>
# Source 82: `examples/creator-profile.example.json`
...
<a id="source-83"></a>
# Source 83: `examples/insight-asset.example.json`
...
<a id="source-84"></a>
# Source 84: `examples/interactive-artifact.example.json`
...
<a id="source-85"></a>
# Source 85: `examples/material-item.example.json`
...
<a id="source-87"></a>
# Source 87: `examples/review-result.example.json`
...
<a id="source-88"></a>
# Source 88: `examples/source-claim.example.json`
...
<a id="source-89"></a>
# Source 89: `examples/topic-candidate.example.json`
...
<a id="source-91"></a>
# Source 91: `scripts/build_handoff.py`

SHA-256: `ed561f1d521d06f09535f1b038c6a63ec3c93ddf620aafee00121c40942e1fb5`
Bytes: `6026`
...
<a id="source-92"></a>
# Source 92: `scripts/requirements.txt`
...
<a id="source-93"></a>
# Source 93: `scripts/validate_specs.py`
